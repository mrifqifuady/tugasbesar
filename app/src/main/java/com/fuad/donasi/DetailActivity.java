...
public class DetailActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    View dialogView;
    Spinner spinner_id_jenis_donasi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar_detail.setTitle("Donasi");
        setSupportActionBar(toolbar_detail);
        Intent i = getIntent();
        id_donatur = i.getStringExtra("id_donatur");
        id_panti = i.getStringExtra("id_panti");
        ...
        adapter = new AdapterDetail(DetailActivity.this, itemList);
...
//        txt_id_jenis_donasi.setText(null);
    ...
    private void DialogForm(String id_donasix, String id_donaturx, String id_pantix, String id_jenis_donasix, String jumlahx, String keteranganx, String tanggalx, String button) {
        ...
        if (!id_donasix.isEmpty()) {
            ...
            kosong();
            txt_id_donatur.setText(id_donatur);
            txt_id_panti.setText(id_panti);
        }
    ...
    private void callVolley() {
        ...
        adapter.notifyDataSetChanged();
        swipe.setRefreshing(true);
        Log.d("URL_select", url_select_donatur + "?id_donatur=" + id_donatur + "&id_panti=" + id_panti);
        // membuat request JSON
        JsonArrayRequest jArr = new JsonArrayRequest(url_select_donatur + "?id_donatur=" + id_donatur + "&id_panti=" + id_panti, new Response.Listener<JSONArray>() {
            @Override
            public void onResponse(JSONArray response) {
                Log.d(TAG, response.toString());
                // Parsing json
